...
- [ ] 4.1 Implement the connection-mask to track-piece lookup covering straight, diagonal, 45 and 90 degree curves, junction and slope pieces, and verify representative masks select the expected piece
